...
const Portfolio = () => {
  ...
  const brands = [
    ...
    { id: 4, name: "Maw & Paw", logo: '/images/brands/Maw and Paw.jpeg' },
    { id: 5, name: 'Korleone', logo: '/images/brands/korleone.jpg' },
    { id: 6, name: 'Lal Gulab', logo: '/images/brands/lal_gulab.jpg' },
    { id: 7, name: 'Magic Paints', logo: '/images/brands/magic_paints.jpg' },
    { id: 8, name: 'Saukhyam', logo: '/images/brands/saukhyam.jpg' },
    { id: 9, name: 'Wit Blox', logo: '/images/brands/wit_blox.jpg' },
    { id: 10, name: "Woof Ministry", logo: '/images/brands/Woof Ministry.jpeg' },
    { id: 11, name: 'Innovative Edge', logo: '/images/brands/innovative_edge.png' },
    { id: 12, name: 'Real Nutri Co', logo: '/images/brands/real_nutri_co.png' },
    { id: 13, name: 'Tresa', logo: '/images/brands/tresa.jpg' },
    { id: 14, name: 'VegOChef', logo: '/images/brands/veg_O_vegan.png' },
    { id: 15, name: 'Zora', logo: '/images/brands/ZORA_Final_Logo.jpg' },
    { id: 16, name: 'Down the Cove', logo: '/images/brands/down_the_cove.jpeg' },
    { id: 17, name: "Waggy Zone", logo: '/images/brands/Waggy Zone.jpeg' },
    { id: 18, name: 'Brown Auric', logo: '/images/brands/Brown Auric.jpeg'},
    { id: 19, name: "Angel's and Co", logo: "/images/brands/Angel's and Co.jpg" },
    { id: 20, name: 'Nioax', logo: '/images/brands/Nioax Coffee.jpg' },
    { id: 21, name: 'Hobbyist Nirvana', logo: '/images/brands/Hobbyist Nirvana.jpeg' },
    { id: 22, name: "Moarmouz", logo: '/images/brands/Moarmouz.jpg' },
  ]
  ...
  const results = [
    ...
    },
    {
      ...
      icon: <FaRocket />,
      sparkline: [0.8, 1.2, 1.5, 1.8, 2.0],
      breakdown: [
        { label: 'Amazon', value: 2.2, suffix: 'x', cap: 7 },
        { label: 'Flipkart', value: 1.8, suffix: 'x', cap: 7 },
        { label: 'Myntra', value: 1.9, suffix: 'x', cap: 7 },
        { label: 'Ajio', value: 1.7, suffix: 'x', cap: 7 },
      ],
    },
    {
      id: 3,
      ...
      icon: <LuSparkles />,
      sparkline: [75, 79, 83, 85, 87],
      breakdown: [
        { label: 'CX Rating', value: 89, suffix: '%' },
        { label: 'Fulfillment', value: 85, suffix: '%' },
        { label: 'Delivery', value: 88, suffix: '%' },
        { label: 'Loyalty', value: 86, suffix: '%' },
      ],
    },
  ]
